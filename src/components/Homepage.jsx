  ...
  return (
    <>
      ...
      <div className="home-heading-container">
        ...
        <Title level={3} className="show-more"><Link to="/cryptocurrencies">Показать больше</Link></Title>
      </div>
      <Cryptocurrencies simplified />
      <div className="home-heading-container">
        <Title level={2} className="home-title">Последние новости</Title>
        <Title level={3}><Link to="/news">Больше</Link></Title>
      </div>
      <News simplified />
    </>
  );
